...
function TestHomePage() {
  ...
  const handleCreateRoom = (e) => {
    e.preventDefault();
    alert(`Room created with ID: ${roomId || 'auto-generated'}. Max participants: ${maxParticipants}`);
  };
        ...
        {activeTab === 'home' && (
          <div className="w-full max-w-md space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold mb-2">Welcome, {profile.name.split(' ')[0]}!</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <button 
                    ...
                    className={`w-full ${roomId ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-700 hover:bg-gray-600'} text-white px-6 py-3 rounded-lg font-medium transition-colors`}
                  >
        ...
        {activeTab === 'create' && (
          <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700 w-full max-w-md">
            ...
            <form onSubmit={handleCreateRoom} className="space-y-6">
              <div>
                <label className="block text-gray-300 mb-2">Meeting ID (optional)</label>
                <input
                  type="text"
                  value={roomId}
                  onChange={(e) => setRoomId(e.target.value)}
                  ...
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-gray-400 text-sm mt-1">Leave blank for auto-generated ID</p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center">
              <p className="text-gray-300 font-medium text-sm mb-1">Developed by</p>
